...
namespace LPAproject
{
    public static class database
    {
        ...
        // Sla een contract op in de database. ONGELDIGE VALUE: EINDDATUM. INSERT INTO HUURDER (Huurder, Naam, ArtikelID, StartDatum, EindDatum) VALUES ('Test', 'TestWater', 1, 23-6-2016, 24-6-2016) HAAKJES;
